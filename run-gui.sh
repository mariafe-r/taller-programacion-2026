#!/usr/bin/env bash
# Compila y ejecuta la interfaz gráfica (Swing) de la biblioteca sin
# necesidad de Gradle ni de conexión a internet. Solo requiere un JDK 17+
# y un entorno gráfico (escritorio/X11) disponible.
#
# Uso:
...
java -cp "$OUT_DIR" com.umb.taller.gui.LibraryGUI
